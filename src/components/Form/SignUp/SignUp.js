...
class SignIn extends React.Component {
  ...
  onSubmitHandler (e) {
    ...
    if (!(this.state.firstName === '' || this.state.lastName === '' || this.state.email === '' || this.state.password === '')
      ...
      axios.post('https://videoappyuvi.herokuapp.com/api/signUp', {
    ...
    return (
      <Form onSubmit={this.onSubmitHandler.bind(this)}>
        ...
        <div className="form-group">
          <label htmlFor="first-name" className="text-success">First Name:</label><br />
          <input
            id="first-name"
        ...
        <div className="form-group">
          <label htmlFor="last-name" className="text-success">Last Name:</label><br />
          <input
            id="last-name"
            className="form-control"
            type="text"
        ...
        <div className="d-flex justify-content-between align-items-end">
          <input type="submit" name="submit" className="btn btn-success btn-md" value="Submit" style = {{marginTop:'10px'}} />
          <Link to="/signIn" className="text-success">Login here</Link>
        </div>
      </Form>
    );
  }
